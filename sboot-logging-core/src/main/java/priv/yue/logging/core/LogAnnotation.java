...
import cn.novelweb.tool.annotation.log.util.SpiderUtils;
import cn.novelweb.tool.http.IpUtils;
import cn.novelweb.tool.http.Region;
...
public class LogAnnotation {
    ...
    public static AccessLogInfo initInfo(final String title, final boolean isGetIp, final Exception e) {
        ...
        // 访问出现的异常信息
        accessLogInfo.setErrorCause(e != null ? ThrowableUtils.getStackTrace(e) : "");
        accessLogInfo.setErrorMsg(e != null ? e.getMessage() : "");
